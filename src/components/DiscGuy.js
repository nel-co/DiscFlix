...
export default class DiscGuy extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={marginTop} id="dgg">
      	<div>
      		<div style={ChannelTitle}>
      			The Disc Golf Guy
      			<a href="https://www.youtube.com/subscription_center?add_user=thediscgolfguy" target="_blank" rel="noopener noreferrer" style={ChannelLink}>
            	<div style={SubscribeBtn}>Subscribe</div>
          	</a>
      		</div>
      	</div>
      	<div className="video-grid">
      	{this.props.dggVideos.length && <OwlCarousel ref="spin" options={owlOptions}>
					{channelItems}
				</OwlCarousel>}
				</div>
      </div>
